...
import com.softplan.codechallenge.model.v1.PessoaDTOUpdate;
...
public class PessoaControllerV1 {
    ...
    public List<PessoaDTOOutput> getAll() {
        ...
        pessoas.forEach((pessoa) ->
                pessoa.add(linkTo(methodOn(PessoaControllerV1.class).findById(pessoa.getId())).withSelfRel()));
    ...
    public PessoaDTOOutput register(@Valid @RequestBody
        ...
        novaPessoa.add(linkTo(methodOn(PessoaControllerV1.class).findById(novaPessoa.getId())).withSelfRel());
    ...
    public ResponseEntity<PessoaDTOOutput> update(@Valid @RequestBody
        ...
        dto.add(linkTo(methodOn(PessoaControllerV1.class).update(pessoa,id)).withSelfRel());
    ...
    public PessoaDTOOutput findById(@PathVariable @ApiParam(value = "Código da pessoa", example = "12") Long id) {
        ...
        pessoaDTOOutput.add(linkTo(methodOn(PessoaControllerV1.class).findById(id)).withSelfRel());
        pessoaDTOOutput.add(linkTo(methodOn(PessoaControllerV1.class).getAll()).withRel("pessoas"));
